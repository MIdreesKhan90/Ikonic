...
function cornerstone_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'cornerstone_custom_background_args',
			array(
...
function cornerstone_scripts() {
	wp_enqueue_style( 'cornerstone-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'cornerstone-style', 'rtl', 'replace' );
	wp_enqueue_style( 'style', get_template_directory_uri() . '/assets/css/style.css' );

	wp_enqueue_script( 'cornerstone-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'custom-script', get_template_directory_uri() . '/assets/js/custom.js', array(), _S_VERSION, true );
